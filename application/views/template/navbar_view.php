<nav class="navbar navbar-expand-lg navbar-dark bg-dark navbar-view">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <?php if ($this->session->userdata('loggedIn')) : ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item <?= $page === 'profileSetting' ? 'active' : '' ?>" href="<?= base_url('profile') ?>">Profile Settings</a></li>
                            <li><a class="dropdown-item <?= $page === 'messages' ? 'active' : '' ?>" href="#">Messages</a>
                            </li>
            ...
            <!-- 在HTML中，使用自訂的data-*屬性來儲存自定義數據 $this->session->userdata('loggedIn') -->
            <?php if (!$this->session->userdata('loggedIn')) : ?>
                <button class="btn btn-outline-success" type="button" id="navbar-login" data-navbarUrl="<?= base_url('login') ?>">LogIn</button>
            <?php endif; ?>
        </div>
    </div>
</nav>
