...
$(document).ready(function () {
    ...
    $('.profileSetting-view').on('click', '#profileSetting-confirm', function () {
        ...
        var fieldsToValidate = [
            ...
            { id: 'profileSetting-phone', validator: inputvalidator.validateNatural, target: 'phone' },
            { id: 'profileSetting-age', validator: inputvalidator.validateInt, target: 'age' },
            { id: 'profileSetting-height', validator: inputvalidator.validateInt, target: 'height' },
            { id: 'profileSetting-weight', validator: inputvalidator.validateFloat, target: 'weight' }
        ];
        ...
        //call Api
        callapi.checkApiResult($(this).data().profilesettingcontrollerupdateprofiledata, fieldValues, 'Updating Profile', 'Update Successful', 'Your profile has been successfully updated.', 'Update Failed', 'Failed to update your profile. Please try again later.', false, '');
    })
